...
for line in lines:
    ...
    # Matches leetcode_123_question-title.py or leetcode_123_question-title.cpp or leetcode_123_question-title.hs
    m = re.search(r'\/.*leetcode_(\d+)_(.*?)\.(?:py|cpp|hs|c)', line)
